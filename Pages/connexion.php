                ...
                <div class="champs">
                    ...
                    <?php
                        if(isset($_GET['email']) && isset($_GET['erreur'])){
                            echo '<input type="email" name="email" id="email" class="inputformulaire inputemail" placeholder="rayzen@gmail.com" value="'.$_GET['email'].'" required>';
                        }
                        else{
                            echo '<input type="email" name="email" id="email" class="inputformulaire inputemail" placeholder="rayzen@gmail.com" required>';
                        }
                    ?>
                    </div>
                    <?php
                    ...
                    <div class="mdp">
                        ...
                        <button hidden type="button" onclick="opmdp('cacher');" class="iconeformulaire" id="buttoncache"><i class="fa-solid fa-face-laugh"></i></button>
                        <button type="button" onclick="opmdp('montrer');" class="iconeformulaire" id="buttonmontre"><i class="fa-solid fa-face-laugh-squint"></i></button>
                    </div>
